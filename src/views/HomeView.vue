<template>
  ...
  <div>
    <ul class="vulnerability-list-box">
      <li>
        <div>
          <router-link to="/BrokenAccessControl">
            A01:2021-Broken Access Control</router-link
          >
          moves up from the fifth position; 94% of applications were tested for
          some form of broken access control. The 34 Common Weakness
          Enumerations (CWEs) mapped to Broken Access Control had more
          occurrences in applications than any other category.
        </div>
      </li>
      <li>
        <div>
          <router-link to="/CryptographicFailures">
            A02:2021-Cryptographic Failures</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/InjectionVulnerability">
            A03:2021-Injection</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/InsecureDesign">
            A04:2021-Insecure Design</router-link
          >
          is a new category for 2021, with a focus on risks related to design
          flaws. If we genuinely want to “move left” as an industry, it calls
      ...
      <li>
        <div>
          <router-link to="/SecurityMisconfiguration">
            A05:2021-Security Misconfiguration</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/VulnerableAndOutdatedComponents">
            A06:2021-Vulnerable and Outdated Components</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/VulnerableAndOutdatedComponents">
            A07:2021-Identification and Authentication Failures</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/SoftwareAndDataIntegrityFailures">
            A08:2021-Software and Data Integrity Failures</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/SecurityLoggingAndMonitoringFailures">
            A09:2021-Security Logging and Monitoring Failures</router-link
          >
      ...
      <li>
        <div>
          <router-link to="/ServerSideRequestForgery">
            A10:2021-Server-Side Request Forgery</router-link
          >
